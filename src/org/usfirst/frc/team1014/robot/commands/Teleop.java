...
import org.usfirst.frc.team1014.robot.commands.teleop.TeleClimb;
...
import org.usfirst.frc.team1014.robot.commands.teleop.TeleLift;
...
public class Teleop extends CommandGroup {
	public Teleop(Drivetrain driveTrain, Grabber grabber, Lifter lifter, Climber climber) {
		...
		super.addParallel(new TeleGrab(Robot.oi.controller1, grabber));
		super.addParallel(new TeleLift(Robot.oi.controller1, lifter));
		super.addParallel(new TeleClimb(Robot.oi.controller1, climber));
	}
}
